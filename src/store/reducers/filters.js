...
const states = (state = defaultState, action) => {
  ...
  switch (action.type) {
    ...
    case getType(actions.filterStatusUpdate.request):
      return { ...state, selectedStatus: entityLoadingStarted(state.selectedStatus, action.payload) };

    case getType(actions.filterStatusUpdate.success):
      return { ...state, selectedStatus: entityLoadingSucceeded(state.selectedStatus, action.payload) };

    case getType(actions.filterStatusUpdate.failure):
      return { ...state, selectedStatus: entityLoadingFailed(state.selectedStatus) };
